...
define('WHATSAPP_SUPPORT_NUMBER', '573001234567');

// -- 3. CONFIGURACIÓN DE ENVÍO DE CORREO (BREVO SMTP) --
define('BREVO_SMTP_HOST', 'smtp-relay.brevo.com');
define('BREVO_SMTP_PORT', 587);
define('BREVO_SMTP_USER', 'tu-email-de-login-en-brevo@dominio.com');
define('BREVO_SMTP_KEY', 'tu-clave-smtp-generada-en-brevo');
define('SMTP_FROM_EMAIL', 'no-reply@tudominio.com');
define('SMTP_FROM_NAME', 'CertiEducación');

// -- 4. CONFIGURACIÓN DE ENVÍO DE SMS (ALTIRIA) --
define('ALTIRIA_LOGIN', 'tu_login_de_altiria');
define('ALTIRIA_PASSWORD', 'tu_password_de_altiria');
